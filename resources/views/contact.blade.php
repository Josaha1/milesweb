...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-gray-600 max-w-2xl mx-auto">Have questions or want to work with us? We'd love to hear from you!
                Use the form below or contact us directly.</p>
        </div>
            ...
            <div class="md:col-span-1 bg-white rounded-lg shadow-md p-6">
                ...
                <div class="pt-6 border-t">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="#"
                            class="bg-pink-600 p-2 rounded-full text-white hover:bg-pink-700 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <div class="h-80 bg-gray-200 rounded-lg overflow-hidden">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3874.1972987897916!2d100.58999007589588!3d13.827188195542034!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTPCsDQ5JzM3LjkiTiAxMDDCsDM1JzMzLjIiRQ!5e0!3m2!1sth!2sth!4v1741295795261!5m2!1sth!2sth"
