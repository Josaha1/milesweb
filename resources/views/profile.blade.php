            ...
            <div class="lg:col-span-1 space-y-6">
                <div class="bg-white rounded-lg shadow p-6 border border-gray-200">
                    ...
                    <div class="space-y-4 text-gray-600">
                        ...
                        <p><span class="font-semibold text-gray-800">📞 Phone:</span>
                            {{ Auth::user()->phone ?? '+66 98 765 4321' }}</p>
                        <p><span class="font-semibold text-gray-800">📍 Location:</span> Bangkok, Thailand</p>
                        <p><span class="font-semibold text-gray-800">📅 Joined:</span>
                            {{ Auth::user()->created_at->format('F d, Y') }}</p>
                    </div>
                    <button
                        class="mt-6 w-full bg-gray-100 text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-200 transition duration-200 flex items-center justify-center">
                    ...
                    <div class="p-6 space-y-4">
                        @foreach (range(1, 4) as $index)
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-gray-900">Created new order #{{ rand(1000, 9999) }}
                                    </p>
